...
public class AccountService {
    ...
    public AccountDTO createAccount(AccountDTO accountDTO) {
        // Verificar que el cliente existe (llamada al otro microservicio)
        // TODO: Habilitar cuando ambos servicios estén corriendo
        /*
        try {
    ...
    public TransactionDTO createTransaction(TransactionDTO transactionDTO) {
        Account account = accountRepository.findByAccountNumberAndStatus(
            ...
            .orElseThrow(() -> new ResourceNotFoundException("Active account not found: " + 
    ...
    public AccountStatementDTO getAccountStatement(Long clientId, LocalDateTime startDate, LocalDateTime endDate) {
        // Log para debug
        System.out.println("Getting statement for client: " + clientId);
        ...
        try {
            ...
            System.out.println("Client info retrieved: " + clientInfo);
        } catch (Exception e) {
            System.err.println("Error getting client info: " + e.getMessage());
        ...
        for (Map.Entry<String, List<Transaction>> entry : transactionsByAccount.entrySet()) {
            ...
            if (account != null) {
                ...
                List<AccountStatementDTO.TransactionDetail> transactionDetails = entry.getValue().stream()
